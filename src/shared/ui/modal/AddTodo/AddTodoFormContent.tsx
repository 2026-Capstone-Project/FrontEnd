...
import type { UseAddTodoFormResult } from '@/shared/hooks/form/useAddTodoForm'
...
import AddTodoFormConfirmModals from '@/shared/ui/modal/AddTodo/AddTodoFormConfirmModals'
import AddTodoFormFields from '@/shared/ui/modal/AddTodo/AddTodoFormFields'

type AddTodoFormContentProps = AddTodoFormProps & {
  todo: UseAddTodoFormResult
}

const AddTodoFormContent = ({
  date,
  mode = 'modal',
  eventId,
  onClose,
...
export default AddTodoFormContent
